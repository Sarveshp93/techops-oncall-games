...
# Install SMI CRDs needed for TrafficSplit if not present
kubectl get crd trafficsplits.split.smi-spec.io >/dev/null 2>&1 ||   kubectl apply -f https://github.com/servicemeshinterface/smi-spec/releases/download/v0.6.1/crds.yaml
